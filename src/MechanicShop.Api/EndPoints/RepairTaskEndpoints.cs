...
using MechanicShop.Contracts.Requests.RepairTask;
...
public static class RepairTaskEndpoints
{
    ...
    {
        var endpoints = app.MapGroup("/api/v{apiVersion:apiVersion}/repair-task")
        ...
        endpoints.MapGet("/", GetRepairTasks)
            ...
            .CacheOutput(c => c.Expire(TimeSpan.FromSeconds(60)).Tag("RepairTasks"))
            .MapToApiVersion(1.0);
    ...
    private static async Task<IResult> CreateRepairTask(
    ...
    private static async Task<IResult> RemoveRepairTask(Guid repairTaskId,
     ISender sender,
     IOutputCacheStore cach,
      CancellationToken ct)
    {
