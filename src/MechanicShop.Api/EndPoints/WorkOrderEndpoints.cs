...
using MechanicShop.Application.Features.WorkOrders.Command.DeleteWorkOrder;
using MechanicShop.Application.Features.WorkOrders.Command.RelocateWorkOrder;
using MechanicShop.Application.Features.WorkOrders.Command.UpdateOrderStates;
using MechanicShop.Application.Features.WorkOrders.Dtos;
using MechanicShop.Application.Features.WorkOrders.Queries.GetWorkOrder;
using MechanicShop.Application.Features.WorkOrders.Queries.GetWorkOrderById;
using MechanicShop.Application.Features.WorkOrders.UpdateWorkOrderRepairTasksCommand;
...
{
    public static void MapWorkOrderEndpoints(this IEndpointRouteBuilder app,ApiVersionSet apiVersionSet)
    {
        var endpoints = app.MapGroup("/api/v{apiVersion:apiVersion}/orkOrders")
            .WithOpenApi()
